...
public class WarnetDaoImpl implements WarnetDao {
    ...
    public WarnetDaoImpl() {
      data.add(new Warnet("2002-02-23","10:00:00","12:00:00",100000));
      data.add(new Warnet("2002-02-24","11:00:00","13:00:00",110000));
      data.add(new Warnet("2002-02-13","12:00:00","04:00:00",120000));
